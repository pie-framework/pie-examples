...
class Main extends _react2.default.Component {
  ...
  constructor(props) {
    ...
    this.isResetRowsRequired = nextProps => this.props.model.config.shuffled === true && nextProps.model.config.shuffled === false || this.props.model.config.rows.length !== nextProps.model.config.rows.length || nextProps.session.answers && nextProps.model.config.rows.length !== Object.keys(nextProps.session.answers).length;
