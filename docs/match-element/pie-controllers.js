(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["pie-controller-match-element"] = factory();
	else
		root["pie-controller-match-element"] = factory();
...
exports['match-element'] = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pie_lib_feedback__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pie_lib_feedback___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__pie_lib_feedback__);



const log = __WEBPACK_IMPORTED_MODULE_0_debug___default()('@pie-element:graph-lines:controller');
...
function model(question, session, env) {
  return new Promise(resolve => {
    ...
    const fb =
      env.mode === 'evaluate'
        ? Object(__WEBPACK_IMPORTED_MODULE_1__pie_lib_feedback__["getFeedbackForCorrectness"])(correctInfo.correctness, question.feedback)
