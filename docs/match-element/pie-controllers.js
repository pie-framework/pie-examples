...
const log = (0, _debug2.default)('@pie-element:graph-lines:controller');
...
const getOutComeScore = (question, env, answers) => {
  ...
  return correctness === 'correct' ? 1 : correctness === 'partial' && question.partialScoring ? getPartialScore(question, answers) : 0;
};
