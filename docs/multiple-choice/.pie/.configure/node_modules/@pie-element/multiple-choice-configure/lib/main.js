...
const Design = (0, _styles.withStyles)(styles)(props => {
  ...
  const promptLabel = _model$configure.promptLabel,
        addChoiceButtonLabel = _model$configure.addChoiceButtonLabel,
        enableAddChoice = _model$configure.enableAddChoice,
        enableAddFeedBack = _model$configure.enableAddFeedBack,
        enableDeleteChoice = _model$configure.enableDeleteChoice;
  ...
  return _react2.default.createElement(
    ...
    enableAddChoice && _react2.default.createElement(
      _Button2.default,
...
const Basics = props => {
  ...
  var _model$configure2 = model.configure;
  const responseTypeLabel = _model$configure2.responseTypeLabel,
        choicesLabel = _model$configure2.choicesLabel,
        enableSelectResponseType = _model$configure2.enableSelectResponseType,
        enableSelectChoiceLabel = _model$configure2.enableSelectChoiceLabel;


  return _react2.default.createElement(
    'div',
    { className: classes.baseTypes },
    enableSelectResponseType && _react2.default.createElement(_choiceType.ChoiceType, { header: responseTypeLabel, value: model.choiceMode, onChange: onChoiceModeChanged }),
    enableSelectChoiceLabel && _react2.default.createElement(_choiceType.KeyType, { header: choicesLabel, value: model.keyMode, onChange: onKeyModeChanged })
  );
};
