...
var SVGWrapper = (function (_super) {
    ...
    SVGWrapper.prototype.setIndent = function (svg, align, shift) {
    ...
    SVGWrapper.prototype.getAlignX = function (W, w, align) {
        if (align === 'right')
            return W - w;
        if (align === 'left')
            return 0;
    ...
    SVGWrapper.prototype.getAlignY = function (H, D, h, d, align) {
        if (align === 'top')
            return H - h;
        if (align === 'bottom')
            return d - D;
