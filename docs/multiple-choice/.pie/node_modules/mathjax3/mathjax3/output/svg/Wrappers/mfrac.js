...
var SVGmfrac = (function (_super) {
    ...
    SVGmfrac.prototype.makeFraction = function (display, t) {
        ...
        var W = Math.max(nbox.w * nbox.rscale, dbox.w * dbox.rscale);
        var nx = this.getAlignX(W, nbox.w * nbox.rscale, numalign) + d + pad;
        var dx = this.getAlignX(W, dbox.w * dbox.rscale, denomalign) + d + pad;
    ...
    SVGmfrac.prototype.makeAtop = function (display) {
        ...
        var pad = (this.node.getProperty('withDelims') ? 0 : tex.nulldelimiterspace);
        var W = Math.max(nbox.w * nbox.rscale, dbox.w * dbox.rscale);
        var nx = this.getAlignX(W, nbox.w * nbox.rscale, numalign) + pad;
        var dx = this.getAlignX(W, dbox.w * dbox.rscale, denomalign) + pad;
    ...
    SVGmfrac.prototype.makeBevelled = function (display) {
        ...
        var _b = this.getBevelData(display), u = _b.u, v = _b.v, delta = _b.delta, nbox = _b.nbox;
        var w = nbox.w * nbox.rscale;
        num.toSVG(svg);
