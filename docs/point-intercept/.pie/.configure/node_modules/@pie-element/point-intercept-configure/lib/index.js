...
const log = (0, _debug2.default)('pie-elements:function-entry:configure');

class PointInterceptConfigure extends HTMLElement {
  constructor() {
    super();
  }
...
exports.default = PointInterceptConfigure;