...
var log = (0, _debug2.default)('@pie-lib:editable-html:plugins:toolbar:editor-and-toolbar');
...
var EditorAndToolbar = exports.EditorAndToolbar = function (_React$Component) {
  ...
  _createClass(EditorAndToolbar, [{
    ...
    value: function render() {
      ...
      var holderNames = (0, _classnames2.default)(classes.editorHolder, inFocus && classes.editorInFocus, readOnly && classes.readOnly, disableUnderline && classes.disabledUnderline);
      var clonedChildren = children;

      if (typeof children !== 'string') {
        clonedChildren = _react2.default.cloneElement(children, { ref: function ref(el) {
            return _this2.editorRef = el;
          } });
      }
...
EditorAndToolbar.propTypes = {
  ...
  focusedNode: _slatePropTypes2.default.node,
...
exports.default = (0, _styles.withStyles)(style)(EditorAndToolbar);