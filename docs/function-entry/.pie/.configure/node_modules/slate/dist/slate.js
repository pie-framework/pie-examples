...
var Text = function (_Record) {
  ...
  createClass(Text, [{
    ...
    value: function fromJSON(object) {
      ...
      if (!leaves) {
        if (object.ranges) {
          index.deprecate('slate@0.27.0', 'The `ranges` property of Slate objects has been renamed to `leaves`.');
...
memoize$2(Text.prototype, ['getDecorations', 'getActiveMarks', 'getMarks', 'getMarksAsArray', 'normalize', 'validate', 'getString']);
  ...
  createClass(Node, [{
    ...
    value: function mapDescendants(iterator) {
      ...
      nodes.forEach(function (node, index$$1) {
        ...
        ret = iterator(ret, index$$1, _this6.nodes);
        if (ret === node) return;
    ...
    value: function getNodeAtPath(path) {
      index.deprecate('0.35.0', 'The `Node.getNodeAtPath` method has been combined into `Node.getNode`.');
    ...
    value: function getDescendantAtPath(path) {
      index.deprecate('0.35.0', 'The `Node.getDescendantAtPath` has been combined into `Node.getDescendant`.');
    ...
    value: function getKeys() {
      index.deprecate('0.35.0', 'The `Node.getKeys` method is deprecated.');
    ...
    value: function getKeysAsArray() {
      index.deprecate('0.35.0', 'The `Node.getKeysAsArray` method is deprecated.');
    ...
    value: function areDescendantsSorted(first, second) {
      ...
      index.deprecate('0.35.0', 'The `Node.areDescendantsSorted` method is deprecated. Use the new `PathUtils.compare` helper instead.');
    ...
    value: function isInRange(range) {
      index.deprecate('0.35.0', 'The `Node.isInRange` method is deprecated. Use the new `PathUtils.compare` helper instead.');
...
var Schema = function (_Record) {
  ...
  createClass(Schema, [{
    ...
    value: function fromJSON(object) {
      ...
      var stack = Stack$2.create({ plugins: plugins });
...
function validateObject(node, rule) {
  if (rule.objects) {
    index.warn('The `objects` schema validation rule was changed. Please use the new `match` syntax with `object`.');
  }
...
function validateType(node, rule) {
  if (rule.types) {
    index.warn('The `types` schema validation rule was changed. Please use the new `match` syntax with `type`.');
  }
...
function validateNodes(node, rule) {
  ...
  while (nextChild()) {
    ...
    if (rule.nodes != null) {
      if (!def) {
        return fail(CHILD_UNKNOWN, { rule: rule, node: node, child: child, index: index$$1 });
      }
  ...
  if (rule.nodes != null) {
    while (min != null) {
      if (offset < min) {
        return fail(CHILD_REQUIRED, { rule: rule, node: node, index: index$$1 });
      }
...
function setKeyGenerator(fn) {
  index.deprecate('0.35.0', 'The `setKeyGenerator()` util is deprecrated. Use the `KeyUtils.setGenerator()` helper instead.');

  return KeyUtils.setGenerator(fn);
}

function resetKeyGenerator() {
  index.deprecate('0.35.0', 'The `resetKeyGenerator()` util is deprecrated. Use the `KeyUtils.resetGenerator()` helper instead.');
