...
var TeXFont = (function (_super) {
    ...
    TeXFont.prototype.addDelimiterVStyles = function (styles, c, data) {
        ...
        var Hb = this.addDelimiterVPart(styles, c, 'beg', beg);
        this.addDelimiterVPart(styles, c, 'ext', ext);
        var He = this.addDelimiterVPart(styles, c, 'end', end);
        var css = {};
        if (mid) {
            var Hm = this.addDelimiterVPart(styles, c, 'mid', mid);
            css.height = '50%';
    ...
    TeXFont.prototype.addDelimiterVPart = function (styles, c, part, n) {
        if (!n)
            return 0;
        var data = this.getChar('normal', n) || this.getChar('-size4', n);
        var css = { content: '"' + this.char(n, true) + '"' };
        if (part !== 'ext') {
