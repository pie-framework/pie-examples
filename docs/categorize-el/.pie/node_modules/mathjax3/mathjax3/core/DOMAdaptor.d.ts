...
export interface DOMAdaptor<N, T, D> {
    ...
    node(type: string, def?: OptionList, children?: (N | T)[], ns?: string): N;
    text(text: string): T;
    head(doc: D): N;
    body(doc: D): N;
    root(doc: D): N;
...
export declare abstract class AbstractDOMAdaptor<N, T, D> implements DOMAdaptor<N, T, D> {
    ...
    node(type: string, def?: OptionList, children?: (N | T)[], ns?: string): N;
    protected abstract create(type: string, ns?: string): N;
    ...
    abstract setAttribute(node: N, name: string, value: string): void;
